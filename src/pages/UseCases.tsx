  ...
  <Layout>
    <section className="relative overflow-hidden py-20 sm:py-28 md:py-36" style={{ background: "linear-gradient(150deg, #07101f 0%, #0d1b33 55%, #071220 100%)" }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-3xl">
          <span className="text-sky-400 text-xs sm:text-sm font-semibold tracking-widest uppercase mb-3 sm:mb-4 block">Use Cases</span>
    ...
    <Section>
      <div className="text-center max-w-2xl mx-auto px-4">
        <h2 className="text-2xl sm:text-3xl font-semibold text-foreground mb-3 sm:mb-4">Ready to unlock your potential?</h2>
        <p className="text-sm sm:text-base text-muted-foreground mb-6 sm:mb-8">Discover how OptiMerce AI can transform your e-commerce operations and drive measurable growth.</p>
